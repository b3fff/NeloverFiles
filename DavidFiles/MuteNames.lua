...
if DevRio:get(David.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(David.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(David.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DavidName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DavidName then 
DavidNames = DevRio:smembers(David.."Rio:Mute:Names"..msg.chat_id_) or ""
if DavidNames and DavidNames[1] then 
for i=1,#DavidNames do 
if DavidName:match("(.*)("..DavidNames[i]..")(.*)") then 
...
DevRio:set(David.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(David.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
